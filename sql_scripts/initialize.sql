...
CREATE TABLE IF NOT EXISTS covid_diagnostics.diagnostic_performance (
	...
	total_pos INT NULL,
	total_neg INT NULL,
	ppa NUMERIC(10, 8) NULL,
	npa NUMERIC(10, 8) NULL,
...
CREATE TABLE IF NOT EXISTS covid_diagnostics.combined_ppv_npv_mat (
	diagnostic_id UUID NULL REFERENCES covid_diagnostics.diagnostics(id) ON DELETE CASCADE,
	source_of_perf_data STRING NULL,
	source_display_name STRING NULL,
	prevalence NUMERIC(10, 8) NULL,
	ppv NUMERIC(10, 8) NULL,
	ppv_95ci_high NUMERIC(10, 8) NULL,
	npv NUMERIC(10, 8) NULL,
	npv_95ci_low NUMERIC(10, 8) NULL,
	npv_95ci_high NUMERIC(10, 8) NULL,
	p_pos NUMERIC(10, 8) NULL,
	p_pos_low NUMERIC(10, 8) NULL,
	p_pos_high NUMERIC(10, 8) NULL,
	fdr NUMERIC(10, 8) NULL,
	fdr_95ci_low NUMERIC(10, 8) NULL,
	fdr_95ci_high NUMERIC(10, 8) NULL,
	fomr NUMERIC(10, 8) NULL,
	fomr_95ci_low NUMERIC(10, 8) NULL,
	fomr_95ci_high NUMERIC(10, 8) NULL,
	created_by STRING NULL,
	created TIMESTAMPTZ NOT NULL DEFAULT clock_timestamp(),
	updated_by STRING NULL,
	updated TIMESTAMPTZ NOT NULL DEFAULT clock_timestamp(),
	PRIMARY KEY (diagnostic_id, source_of_perf_data, prevalence)
);
