...
layout = html.Div(children=[
    dbc.Container([
        dbc.Row([
                 ...
                 #dbc.Col(html.H1("Welcome to IQTLabs' COVID Toolkit", className="text-center"), className="mb-5 mt-5")
                ]),
        ...
        dbc.Row([
                 ...
                 dbc.Col(dbc.Card(children=[html.H3(children='Explore other work from BNext',
                                                    className="text-center"),
                                            html.A([
                 ...
                 dbc.Col(dbc.Card(children=[html.H3(children='Explore other research areas of IQTLabs',
                                                    className="text-center"),
                                            html.A([
